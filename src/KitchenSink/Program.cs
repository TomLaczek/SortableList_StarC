...
namespace KitchenSink
{
    ...
    class Program 
    {
        static void Main()
        {
            ...
            //Handle.GET("/KitchenSink/partial/SortableListPage", () =>
            //    {
            //        Session session = Session.Current;
            //        return Db.Scope(() =>
            //        { 
            //        var person = Db.SQL<Person>("SELECT p FROM Person p").First;
            //            var json = new SortableList
            //        {
            //            Data = person
            //        };
            //        if(session==null)
            ...
            //        });
            //    });
            Handle.GET("/KitchenSink/partial/SortableListPage", () => new SotrableListPage());
            Handle.GET("/KitchenSink/SortableListPage", () => WrapPage<SotrableListPage>("/KitchenSink/partial/SortableListPage"));
